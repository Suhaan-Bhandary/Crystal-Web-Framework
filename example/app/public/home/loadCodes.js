const codes = [
  ...
  },
  {
    ...
    code: [`router.get("/user/:id", Controller::getUser);`],
  },
  {
  ...
  },
  {
    id: "json__code__1",
    code: [
      `void Controller::saveUserData(Crystal::Request &request, Crystal::Response &response) {`,
      `   try {`,
  ...
  },
  {
    id: "caching__code__1",
    code: [
      `void Controller::customRouteController(Crystal::Request &request, Crystal::Response &response) {`,
